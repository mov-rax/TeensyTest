  ...
  */
  ...
  string print_ZINT(const mpz_t & a){
    ...
    */
    ...
    char s[l];
#endif
    mpz_get_str (s, 10, sizeof(s), a) ; //EDIT: MOV-RAX
    string tmp(s);
  ...
  string hexa_print_ZINT(const mpz_t & a){
    ...
    if (mpz_sgn(a) == -1){
      ...
      mpz_init(tmpint);
      mpz_neg(tmpint, a);
      mpz_get_str(s,16,sizeof(s),tmpint); //EDIT: MOV-RAX
      mpz_clear(tmpint);
      
      res = "-" + res + s;
    }
    else {
      mpz_get_str(s,16,sizeof(s),a); //EDIT: MOV-RAX
      res += s;
    }
#else
    mpz_get_str (s,16,a) ;
  ...
  string octal_print_ZINT(const mpz_t & a){
    ...
    if (mpz_sgn(a) == -1){
      ...
      mpz_init(tmpint);
      mpz_neg(tmpint, a);
      mpz_get_str(s,8,sizeof(s),tmpint); //EDIT: MOV-RAX
      mpz_clear(tmpint);
      res = "-" + res + s;
    }
    else {
      mpz_get_str(s,8,sizeof(s),a); //EDIT: MOV-RAX
      res += s;
    }
#else
    mpz_get_str (s,8,a) ;
  ...
  string binary_print_ZINT(const mpz_t & a){
    ...
    if (mpz_sgn(a) == -1){
      ...
      mpz_init(tmpint);
      mpz_neg(tmpint, a);
      mpz_get_str(s,2,sizeof(s),tmpint); //EDIT: MOV-RAX
      mpz_clear(tmpint);
      res = "-" + res + s;
    }
    else {
      mpz_get_str(s,2,sizeof(s),a); //EDIT: MOV-RAX
      res += s;
    }
#else
    mpz_get_str (s,2,a) ;
