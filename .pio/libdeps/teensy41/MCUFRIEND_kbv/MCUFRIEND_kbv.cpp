...
void MCUFRIEND_kbv::reset(void)
{
    ...
    RESET_IDLE;
    delay(10);  
//	WriteCmdData(0xB0, 0x0000);   //R61520 needs this to read ID  //commented out 4/21
}
...
{
    pushColors_any(_MW, (uint8_t *)block, n, first, 0);  //was 0-->3
}
...
#if defined(SUPPORT_1963) && USING_16BIT_BUS 
    case 0x1963:
        _lcd_capable = AUTO_READINC | MIPI_DCS_REV1 | READ_NODUMMY | INVERT_RGB;//| INVERT_SS |
        // from NHD 5.0" 8-bit
